#ifndef FCENGINEEDITOR_EditLanguageDialog_H__INCLUDE
#define FCENGINEEDITOR_EditLanguageDialog_H__INCLUDE
#include <wx/dialog.h>
...
class EditLanguageDialog : public EditDialogBase
{
    enum
    {
