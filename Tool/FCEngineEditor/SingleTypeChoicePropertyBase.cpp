                          ...
                          wxPGProperty* property )
{
    ...
    ((EnginePropertyGrid*)p->GetGrid())->FreeEditorCtrl();
...
SingleTypeChoicePropertyBase::SingleTypeChoicePropertyBase( const wxString& label,
...
SingleTypeChoicePropertyBase::~SingleTypeChoicePropertyBase()
{

}

const wxPGEditor* SingleTypeChoicePropertyBase::DoGetEditorClass() const
{
    return wxPGEditor_TextCtrlAndButton;
}

wxPGEditorDialogAdapter* SingleTypeChoicePropertyBase::GetEditorDialog() const
{
