...
#ifdef LWM_WXWIDGETS_HACK
    void SetIgnoreEnterFlag(bool value) {m_ignoreEnterWhenDropDown = value;}
#endif
...
#ifdef LWM_WXWIDGETS_HACK
        m_ignoreEnterWhenDropDown = false;
#endif
    }
...
#ifdef LWM_WXWIDGETS_HACK
    bool m_ignoreEnterWhenDropDown;
#endif
