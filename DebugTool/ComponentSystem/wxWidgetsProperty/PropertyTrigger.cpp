        ...
        case eRPT_Float:
            {
                ...
                BEATS_ASSERT(bConvertSuccess, _T("Convert string to float failed! %s"), m_strRefValue.c_str());
        ...
        case eRPT_Enum:
            {
                ...
                bool bConvertSuccess = pEndPtr[0] == 0;
                BEATS_ASSERT(bConvertSuccess, _T("Convert string to int failed! %s"), m_strRefValue.c_str());
