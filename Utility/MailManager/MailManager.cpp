...
////////////////////////////////////////////////////////////////////////////////
//        NAME: CMailManager
// DESCRIPTION: Constructor of CMailManager class.
//   ARGUMENTS: none
// USES GLOBAL: none
...
//							JP 2010-07-08
////////////////////////////////////////////////////////////////////////////////
CMailManager* CMailManager::m_pInstance = NULL;
...
////////////////////////////////////////////////////////////////////////////////
//        NAME: CMailManager
// DESCRIPTION: Destructor of CMailManager class.
//   ARGUMENTS: none
...
CMailManager::~CMailManager()
{
    if(SendBuf)
    {
        BEATS_SAFE_DELETE_ARRAY(SendBuf);
        SendBuf = NULL;
    }
    if(RecvBuf)
    {
        BEATS_SAFE_DELETE_ARRAY(RecvBuf);
        RecvBuf = NULL;
    }
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::AddAttachment(const char *Path)
{
    assert(Path);
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::AddRecipient(const char *email, const char *name)
{	
    if(!email)
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::AddCCRecipient(const char *email, const char *name)
{	
    if(!email)
        throw ECSmtp(ECSmtp::UNDEF_RECIPIENT_MAIL);
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::AddBCCRecipient(const char *email, const char *name)
{	
    if(!email)
        throw ECSmtp(ECSmtp::UNDEF_RECIPIENT_MAIL);
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::AddMsgLine(const char* Text)
{
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::DelMsgLine(unsigned int Line)
{
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::DelRecipients()
{
    Recipients.clear();
}
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::DelBCCRecipients()
{
    BCCRecipients.clear();
}
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::DelCCRecipients()
{
    CCRecipients.clear();
}
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::DelAttachments()
{
    Attachments.clear();
}
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::ModMsgLine(unsigned int Line,const char* Text)
{
    if(Text)
    {
        if(Line > MsgBody.size())
...
void CMailManager::Send()
{
    ...
    size_t rcpt_count = Recipients.size();
    if(rcpt_count == 0)
    ...
    for(size_t i = 0; i < BCCRecipients.size(); i++)
    {
    ...
    TotalSize = 0;
    for(size_t FileId = 0; FileId < Attachments.size(); FileId++)
    {
        ...
        else
        {
            ...
            MsgPart = 0;
            for(size_t i = 0; i < FileSize / 54 + 1; i++)
            {
                size_t res = fread(FileBuf, sizeof(char), 54, hFile);
    ...
    BEATS_SAFE_DELETE_ARRAY(FileBuf);
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
SOCKET CMailManager::ConnectRemoteServer(const char *szServer,const unsigned short nPort_)
{
    ...
    while(true)
    {
        ...
        if((res = select((int)hSocket+1, NULL, &fdwrite, &fdexcept, &timeout)) == SOCKET_ERROR)
        {
            closesocket(hSocket);
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
int CMailManager::SmtpXYZdigits()
{
    assert(RecvBuf);
    if(RecvBuf == NULL)
        return 0;
...
//							JP 2010-07-07
////////////////////////////////////////////////////////////////////////////////
void CMailManager::FormatHeader(char* header)
{
...
void CMailManager::ReceiveData()
{
    ...
    while(true)
    {
        ...
        if((res = select((int)hSocket+1, &fdread, NULL, NULL, &time)) == SOCKET_ERROR)
        {
...
void CMailManager::SendData()
{
    ...
    while(true)
    {
        ...
        if((res = select((int)hSocket+1, NULL, &fdwrite, NULL, &time)) == SOCKET_ERROR)
        {
            FD_CLR(hSocket, &fdwrite);
            throw ECSmtp(ECSmtp::WSA_SELECT);
        }
        ...
        if(res && FD_ISSET(hSocket, &fdwrite))
        {
            if(nLeft > 0)
            {
                if((res = send((int)hSocket, &SendBuf[idx], nLeft, 0)) == SOCKET_ERROR)
                {
                    FD_CLR(hSocket,&fdwrite);
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
const char* CMailManager::GetLocalHostName() const
{
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
size_t CMailManager::GetRecipientCount() const
{
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
size_t CMailManager::GetBCCRecipientCount() const
{
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
size_t CMailManager::GetCCRecipientCount() const
{
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
const char* CMailManager::GetReplyTo() const
{
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
const char* CMailManager::GetMailFrom() const
{
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
const char* CMailManager::GetSenderName() const
{
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
const char* CMailManager::GetSubject() const
{
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
const char* CMailManager::GetXMailer() const
{
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
CSmptXPriority CMailManager::GetXPriority() const
{
    return m_iXPriority;
}

const char* CMailManager::GetMsgLineText(size_t Line) const
{
    if(Line > MsgBody.size())
        throw ECSmtp(ECSmtp::OUT_OF_MSG_RANGE);
...
size_t CMailManager::GetMsgLines() const
{
    return MsgBody.size();
}
...
// AUTHOR/DATE: JP 2010-01-28
////////////////////////////////////////////////////////////////////////////////
void CMailManager::SetXPriority(CSmptXPriority priority)
{
...
//							JP 2010-07-08
////////////////////////////////////////////////////////////////////////////////
void CMailManager::SetReplyTo(const char *ReplyTo)
{
    m_sReplyTo.erase();
...
//							JP 2010-07-08
////////////////////////////////////////////////////////////////////////////////
void CMailManager::SetSenderMail(const char *EMail)
{
    m_sMailFrom.erase();
...
//							JP 2010-07-08
////////////////////////////////////////////////////////////////////////////////
void CMailManager::SetSenderName(const char *Name)
{
    m_sNameFrom.erase();
...
//							JP 2010-07-08
////////////////////////////////////////////////////////////////////////////////
void CMailManager::SetSubject(const char *Subject)
{
    m_sSubject.erase();
...
//							JP 2010-07-08
////////////////////////////////////////////////////////////////////////////////
void CMailManager::SetXMailer(const char *XMailer)
{
    m_sXMailer.erase();
...
//							JP 2010-07-08
////////////////////////////////////////////////////////////////////////////////
void CMailManager::SetLogin(const char *Login)
{
    m_sLogin.erase();
...
//							JP 2010-07-08
////////////////////////////////////////////////////////////////////////////////
void CMailManager::SetPassword(const char *Password)
{
    m_sPassword.erase();
...
//							JO 2010-0708
////////////////////////////////////////////////////////////////////////////////
void CMailManager::SetSMTPServer(const char* SrvName,const unsigned short SrvPort)
{
