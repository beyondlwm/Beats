#ifndef RENDER_RENDERSTATEPARAM_BLENDRENDERSTATEPARAM_H__INCLUDE
#define RENDER_RENDERSTATEPARAM_BLENDRENDERSTATEPARAM_H__INCLUDE
...
public:
    ...
    DECLARE_REFLECT_GUID(CBlendRenderStateParam, 0x15CA0218, CRenderStateParamBase)
public:
