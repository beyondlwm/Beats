...
CSkeleton::CSkeleton(CSerializer& serializer)
    :super(serializer)
{
    DECLARE_PROPERTY(serializer, m_uTestComponentValue, true, 0xff0000ff, _T("TestValue"), NULL, _T("I'm a test bool tip"), NULL);
}
